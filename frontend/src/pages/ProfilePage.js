...
const ProfilePage = observer(() => {
    ...
    return (
        <Container  style={{minHeight: "90vh"}}>
            ...
            <Row>
                <Col md={4}>
                    <Card style={{display: "flex", boxShadow: "0px 0px 8px 0px rgba(34, 60, 80, 0.2)", flexDirection: "column", alignItems: "center", padding: 30, border: 0, borderRadius: 0}}>
                        <div style={{display: "flex", justifyContent: "end", width: "100%", position: "absolute", top: 20, right: 20}}>
                        ...
                        <div style={{display: "flex", alignItems: "center", color: 'gray', fontSize: "0.9rem", marginBottom: 10}}>
                            {
                                data.verified ?
                                    <>
                ...
                <Col md={8} >
                    <Card style={{borderRadius: 0, border: 0, height: '100%', boxShadow: "0px 0px 8px 0px rgba(34, 60, 80, 0.2)"}} >
                        <CardTitle style={{display: "flex", background: "#F7F7F7",margin: 0,padding: "10px 30px 10px 30px" ,justifyContent: "space-between", alignItems: "center"}}>
                                ...
                                overlay={
                                    <Popover>
                                        <Popover.Body style={{display: 'flex', flexDirection: 'column', paddingInline: 0}}>
                                            <Button variant="outline-dark" style={{border: 0, display: "flex", justifyContent: "start", alignItems: "center", borderRadius: 0}}><FontAwesomeIcon style={{marginRight: 10}} icon={faLock} />Change password</Button>
                                            <Button variant="outline-dark" style={{border: 0, display: "flex", justifyContent: "start", alignItems: "center", borderRadius: 0}}><FontAwesomeIcon style={{marginRight: 10}} icon={faPenToSquare} />Edit profile</Button>
                                            <Button variant="outline-dark" style={{border: 0, display: "flex", justifyContent: "start", alignItems: "center", borderRadius: 0}}><FontAwesomeIcon style={{marginRight: 10}} icon={faTrashCan} />Delete profile</Button>
                                        </Popover.Body>
                                    </Popover>
                                }
                            >
                                <Button variant="outline-dark" style={{border: 0}}><FontAwesomeIcon icon={faGear} /> Settings</Button>
                            </OverlayTrigger>
                        </CardTitle>
                        <Card.Body style={{padding: 30}}>
                            <Card.Text style={{display: "flex",margin: 0 ,justifyContent: "space-between", alignItems: "center"}}>
